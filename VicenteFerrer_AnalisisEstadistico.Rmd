...
claim <- read.csv("./train_clean2.csv", header=TRUE, stringsAsFactors=TRUE) 
```
...
Se trata de un contraste de dos muestras emparejadas sobre la media con varianzas desconocidas. Ya que queremos comparar dos muestras que están univocamente relacionadas.
