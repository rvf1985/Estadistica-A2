...
Ya se implementó una función en el ejercicio 3 que se puede utilizar en este caso también. El resultado que arroja es:
...
2. Si obtenemos infinitas muestras del conjunto de datos, el 95% de los intervalos de confianza calculados a partir de esas muestras contendrían el valor medio del coste (UltCost).

3. ¿Venden más las tiendas de USA que las de fuera de USA?Podemos afirmar que las ventas en las tiendas de USA son superiores a las de fuera de USA con unnivel de confianza del 95%.

4. ¿Son diferentes las ventas de zonas urbanas en comparación con las ventas de zonas rurales?No se observan diferencias significativas al 95% en las ventas de las tiendas en zonas rurales y urbanas.

5. ¿Más de la mitad de las tiendas tienen un precio inferior al de la competencia?Con un nivel de confianza del 95%, se puede afirmar que más de la mitad de las tiendas usan unaestrategia de precios bajos.

6. ¿Hay una estrategia de precios diferente en las tiendas de USA en relación a las de fuera de USA?No se observan diferencias en la proporción de tiendas que usan estrategia de precios bajos en USAcomparado con fuera de USA con un nivel de confianza del 95%.

7. ¿Hay una estrategia de precios diferente en las tiendas de USA en relación a las de fuera de USA?No se observan diferencias en la proporción de tiendas que usan estrategia de precios bajos en USAcomparado con fuera de USA con un nivel de confianza del 95%.
